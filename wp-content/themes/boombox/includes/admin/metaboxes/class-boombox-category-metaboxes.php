				...
				'tab_logo' => array(
					...
					'fields' => array(
						...
						'boombox_term_logo'                     => array(
							'type'         => 'image',
							'standalone'   => true,
							'label'        => esc_html__( 'Light Logo', 'boombox' ),
							'order'        => 20,
							'sub_order'    => 30,
							'default'      => '',
						),
						// Dark Logo
						'boombox_term_logo_dark'                     => array(
							'type'         => 'image',
							'standalone'   => true,
							'label'        => esc_html__( 'Dark Logo', 'boombox' ),
							'order'        => 30,
							'default'      => '',
						),
						// Light Logo HDPI
						'boombox_term_logo_hdpi'                => array(
							'type'        => 'image',
							'standalone'  => true,
							'label'       => esc_html__( 'Light Logo HDPI', 'boombox' ),
							'description' => esc_html__( 'An image for High DPI screen (like Retina) should be twice as big.', 'boombox' ),
							'order'       => 40,
							'default'     => '',
						),
						// Dark Logo HDPI
						'boombox_term_logo_dark_hdpi'                => array(
							'type'        => 'image',
							'standalone'  => true,
							'label'       => esc_html__( 'Dark Logo HDPI', 'boombox' ),
							'description' => esc_html__( 'An image for High DPI screen (like Retina) should be twice as big.', 'boombox' ),
							'order'       => 50,
							'default'     => '',
						),
						...
						// Mobile Dark Logo
						'boombox_term_mobile_logo_dark'              => array(
							'type'         => 'image',
							'standalone'   => true,
							'label'        => esc_html__( 'Dark Logo', 'boombox' ),
							'order'        => 90,
						...
						// Mobile Dark Logo HDPI
						'boombox_term_mobile_logo_dark_hdpi'         => array(
							'type'        => 'image',
							'standalone'  => true,
							'label'       => esc_html__( 'Dark Logo HDPI', 'boombox' ),
							'description' => esc_html__( 'An image for High DPI screen (like Retina) should be twice as big.', 'boombox' ),
