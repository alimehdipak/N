				...
				add_action( 'wp_footer', function () use ( $gallery_id, $attachments, $total ) { ?>
					<div id="<?php echo esc_attr( $gallery_id ); ?>" class="bb-post-gallery-content">
						<div class="bb-gl-header">
							...
							<?php
							if ( apply_filters( 'boombox/single_post/gallery_show_logo', true ) ) {
								$branding_logo_small_url      = boombox_get_theme_option( 'branding_logo_small' );
								$branding_logo_dark_small_url = boombox_get_theme_option( 'branding_logo_dark_small' );

								if ( $branding_logo_small_url || $branding_logo_dark_small_url ) { ?>
									<div class="bb-gl-logo">
										<?php if ( $branding_logo_small_url ) {
											$small_logo_class_mode = $branding_logo_dark_small_url ? 'bb-logo-light' : ''; ?>

											<img class="<?php echo $small_logo_class_mode; ?>" src="<?php echo esc_url( $branding_logo_small_url ); ?>" alt="<?php bloginfo( 'name' ); ?>" />
										<?php }
										if ( $branding_logo_dark_small_url ) {
											$small_logo_dark_class_mode = $branding_logo_small_url ? 'bb-logo-dark' : ''; ?>

											<img class="<?php echo $small_logo_dark_class_mode; ?>" src="<?php echo esc_url( $branding_logo_dark_small_url ); ?>" alt="<?php bloginfo( 'name' ); ?>" />
										<?php } ?>
